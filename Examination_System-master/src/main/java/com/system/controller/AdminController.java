...
public class AdminController {
    ...
    public String showStudent(Model model, Integer page) throws Exception {
        ...
        model.addAttribute("countStudent",studentService.getCountStudent());
    ...
    public String showTeacher(Model model, Integer page) throws Exception {
        ...
        model.addAttribute("pagingVO", pagingVO);
        model.addAttribute("countTeacher",teacherService.getCountTeacher());
    ...
    public String showCourse(Model model, Integer page) throws Exception {
        ...
        model.addAttribute("pagingVO", pagingVO);
        model.addAttribute("countCourse",courseService.getCountcourse());
    ...
    // 普通用户账号密码重置
    @RequestMapping("/userPasswordRset")
    public String userPasswordRsetUI() throws Exception {
        return "admin/userPasswordRset";
    }

    // 普通用户账号密码重置处理
    @RequestMapping(value = "/userPasswordRset", method = {RequestMethod.POST})
    public String userPasswordRset(UserLogin userLogin) throws Exception {
        ...
        if (u != null) {
            ...
            boolean flag = userLoginService.updateByName(userLogin.getUsername(), u);
            if(flag)
                throw new CustomException("密码修改成功");
        } else {
    ...
    // 本账户密码重置
    @RequestMapping("/passwordRset")
    public String passwordRsetUI() throws Exception {
        return "admin/passwordRset";
    }
