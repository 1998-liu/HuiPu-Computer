...
public class StudentController {
    ...
    public String stuCourseShow(Model model, Integer page) throws Exception {
        ...
        int countAllCourse = courseService.getCountcourse();
        if (page == null || page == 0) {
    ...
    public String selectedCourse(Model model) throws Exception {
        ...
        for (SelectedCourseCustom selectedCourseCustom : list) {
            if(!selectedCourseCustom.getOver())
                ++count;
        }

        model.addAttribute("selectedCourseList", list);
        model.addAttribute("countSelectedCourse",count);
    ...
    public String overCourse(Model model) throws Exception {
        ...
        model.addAttribute("selectedCourseList", list);
        model.addAttribute("countOverCourse",count);

        return "student/overCourse";
    }

    //修改密码
    @RequestMapping(value = "/passwordRset")
    public String passwordRset() throws Exception {
        return "student/passwordRset";
    }
