            ...
            <section class="chart_section">
                        ...
                        <div class="card card-shadow">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    <tbody>
                                    <tr>
                                        <th><i class="fa fa-twitter text-success" aria-hidden="true"></i></th>
                                        <td>Twitter</td>
                                        <td><span>972 Records</span></td>
                                        <td>35% <i class="zmdi zmdi-caret-up"></i></td>
                                    </tr>
                                    <tr>
                                        <th><i class="fa fa-facebook text-success" aria-hidden="true"></i></th>
                                        <td>Facebook</td>
                                        <td><span>671 Records</span></td>
                                        <td>18% <i class="zmdi zmdi-caret-up"></i></td>
                                    </tr>
                                    <tr>
                                        <th><i class="fa fa-linkedin text-success" aria-hidden="true"></i></th>
                                        <td>linkedin</td>
                                        <td><span>462 Records</span></td>
                                        <td>37% <i class="zmdi zmdi-caret-up"></i></td>
                                    </tr>
                                    <tr>
                                        <th><i class="fa fa-instagram text-success" aria-hidden="true"></i></th>
                                        <td>Instagram</td>
                                        <td><span>117 Records</span></td>
                                        <td>19% <i class="zmdi zmdi-caret-up"></i></td>
                                    </tr>
                                    <tr>
                                        <th><i class="fa fa-google-plus text-success" aria-hidden="true"></i></th>
                                        <td>Google</td>
                                        <td><span>382 Records</span></td>
                                        <td>29% <i class="zmdi zmdi-caret-up"></i></td>
                                    </tr>
                                    <tr>
                                        <th><i class="fa fa-mail-forward text-success" aria-hidden="true"></i></th>
                                        <td>Mailchimp</td>
                                        <td><span>322 Records</span></td>
                                        <td>31% <i class="zmdi zmdi-caret-down"></i></td>
                                    </tr>

                                    <tr>
                                        <th><i class="fa fa-lightbulb-o text-success" aria-hidden="true"></i></th>
                                        <td>Other</td>
                                        <td><span>267 Records</span></td>
                ...
                <div class="row">
                                            ...
                                            <td>
                                                <ul class="list-unstyled users-list m-0">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Josh Hazlewood" class="pull-up list_membler">
                                                        <img class="media-object rounded-circle" src="assets/images/img1.jpg" alt="">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Beth Mooney" class="pull-up list_membler">
                                                        <img class="media-object rounded-circle" src="assets/images/img2.jpg" alt="">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Megan Schutt" class="pull-up list_membler">
                                                        <img class="media-object rounded-circle" src="assets/images/img3.jpg" alt="">
                                                    </li>
                                                    <li class="list_membler">
                                                        <span class="badge badge-info">+10 more</span>
                                                    </li>
                                                </ul></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <li class="list_membler">
                                                        <span class="badge badge-info">+6 more</span>
                                                    </li>
                                                </ul></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Nicole Bolton" class="pull-up list_membler">
                                                        <img class="media-object rounded-circle" src="assets/images/img3.jpg" alt="">
                                                    </li>
                                                    <li class="list_membler">
                                                        <span class="badge badge-info">+12 more</span>
                                                    </li>
                                                </ul></td>
                                            <td><a href="#" class="btn btn-sm btn-outline-success round">Tablet</a></td>
                                            <td>
                    ...
                    <div class="col-lg-4 mb-4 d-flex align-items-stretch">
                        <div class="stats-wrap widthfull sale_stets card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3>Timetable</h3>
                                </div>
                            ...
                            <div class="card_chart">
                                <div class="school-timetable">
                                    ...
                                    <h6><i class="ion-android-home"></i> Room <span>104 B</span></h6>
                                    <h6><i class="ion-android-time"></i> Mon, October 21st <span>10.00 AM - 12.00 AM</span></h6>
                                    <ul>
                                        <li>
                                    ...
                                    <h6><i class="ion-android-home"></i> Room <span>98 C</span></h6>
                                    <h6><i class="ion-android-time"></i> Fri, November 1st <span>09.00 AM - 10.00 AM</span></h6>
                                    <ul>
                                        <li>
                                            <img class="img-circle round_small" src="assets/images/img1.jpg" alt="">
                                        </li>
